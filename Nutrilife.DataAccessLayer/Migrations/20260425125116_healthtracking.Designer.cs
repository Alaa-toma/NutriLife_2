...
namespace Nutrilife.DataAccessLayer.Migrations
{
    ...
    [Migration("20260425125116_healthtracking")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nutrilife.DataAccessLayer.Models.HealthTracking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nutrilife.DataAccessLayer.Models.InBodyScan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<float>("BoneMineralContent")
                        .HasColumnType("real");

                    b.Property<float>("FatMass")
                        .HasColumnType("real");

                    b.Property<int>("HealthTrackingId")
                        .HasColumnType("int");

                    b.Property<float>("MuscleMass")
                        .HasColumnType("real");

                    b.Property<string>("RowAIOutput")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<float>("VisceralFatLevel")
                        .HasColumnType("real");
                    ...
                    b.HasIndex("HealthTrackingId");

                    b.ToTable("inBodyScans");
                });

            modelBuilder.Entity("Nutrilife.DataAccessLayer.Models.ManualMeasurement", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nutrilife.DataAccessLayer.Models.InBodyScan", b =>
                {
                    b.HasOne("Nutrilife.DataAccessLayer.Models.HealthTracking", "healthTracking")
                        .WithMany()
                        .HasForeignKey("HealthTrackingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("healthTracking");
                });
